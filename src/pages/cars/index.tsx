...
export function CarListPage(props: CarListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCars({
        relations: ['company', 'booking.count', 'car_status.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('car_status', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'car_status',
          header: 'Car Status',
          accessorKey: 'car_status',
          cell: ({ row: { original: record } }: any) => record?._count?.car_status,
        }
      : null,
