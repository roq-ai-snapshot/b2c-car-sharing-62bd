...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createCompany() {
    ...
    if (body?.operations_dashboard?.length > 0) {
      const create_operations_dashboard = body.operations_dashboard;
      body.operations_dashboard = {
        create: create_operations_dashboard,
      };
    } else {
      delete body.operations_dashboard;
    }
