...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'Customer Complaint Resolution.update': {
    roles: ['owner', 'admin', 'business-owner', 'operations-manager', 'operations-staff', 'fleet-manager'],
    key: 'customer_complaint_resolution',
    tenantPath: [],
    userPath: [],
  },
};
